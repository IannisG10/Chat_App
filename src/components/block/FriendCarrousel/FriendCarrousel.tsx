    ...
    return(
        <div className=" flex flex-col justify-center items-center gap-8">
            ...
            <div className=" flex items-center gap-2">
                <BiChevronLeft size={36} className=" p-1 transition-all duration-150 cursor-pointer hover:bg-gray-50 rounded-full"/>
                ...
                <BiChevronRight className=" p-1 transition-all duration-150 cursor-pointer hover:bg-gray-50 rounded-full" size={36}/>
            </div>
